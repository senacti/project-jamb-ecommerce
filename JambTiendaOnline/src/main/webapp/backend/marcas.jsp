                ...
                <div class="modal-content">
                    ...
                    <form class="form" id="frmMarcas">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nombreMar" id="nombreMar" class="form-control" placeholder="Ingresar Nombre Marca">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label style="font-family: sans-serif">Estado de la Marca</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                        ...
                        <div class="modal-footer clearfix">
                            <button id="btn-save" type="submit" class="btn btn-outline-success float-right">Registrar Marca <span class="fas fa-save"></span></button>
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="card card-purple card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Registrar Marcas</h3>
                            </div>
                            <div class="card-body">
...
<script src="../js/scriptMarcas.js" type="text/javascript"></script>
