...
<%@page import="com.tienda.online.config.Fecha"%>
...
<html>
    ...
    <body>       
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand"><img src="img/af_logo.png" width="40px"></a>
                            ...
                            <div class="tab-pane fade show active" id="pills-iniciar" role="tabpanel">
                                <form action="Controlador">
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="16" class="form-control" placeholder="9999-9999-9999-9999">
                                    </div>
                                    <div class="form-group">
                                        <label>Codigo Seguridad</label>
                                        <input type="text" maxlength="3" class="form-control" placeholder="xxxx">
                                    </div>
                                    <div class="form-group">
                                        <label>Monto</label>
                                        <input type="text" disabled="" name="txtmonto" value="$.${totalPagar}0" class="form-control h1">
                                    </div>                                   
